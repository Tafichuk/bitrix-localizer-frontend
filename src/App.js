            ...
            <div style={{ ...s.card, marginTop: 16 }}>
              ...
              <div style={s.howList}>
                {[
                  ...
                  ['🌐', 'Claude переводит текст на выбранные языки'],
                  ['🤖', 'Claude Vision анализирует каждый скриншот'],
                  ['📸', 'Playwright делает скриншоты нужных страниц на вашем портале'],
                  ['📦', 'Создаёт ZIP с HTML файлами для каждого языка'],
                ].map(([icon, text], i) => (
          ...
          <div style={s.rightCol}>
            ...
            <div style={s.card}>
              ...
              <div style={s.stepsRow}>
                {stepLabels.map(step => {
                  ...
                  const idle = currentStep < step.n && !running;
                  return (
            ...
            {downloadUrl && (
              <div style={s.downloadCard}>
                ...
                <a
                  href={downloadUrl}
                  download="localized-articles.zip"
                  style={s.downloadBtn}
                >
                  ⬇️ Скачать ZIP архив
                </a>
...
const s = {
  ...
  langWarning: { marginTop: 6, fontSize: 12, color: '#ef4444' },
  submitBtn: {
    width: '100%',
    padding: '13px',
